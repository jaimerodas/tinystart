...
// development with letter_opener. It is what makes a password reset end in a
// link you can find rather than in silence. That matters on a laptop, or on
// a server whose token has gone missing.
//
